...
namespace Experiment_with_controls
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //reminder adding break points are to see auto window
        private void numberTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
           number.Text = numberTextBox.Text;   //sets the text in textblock so its the same as the text in the textbox
        ...
        private void editableComboBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            e.Handled = !int.TryParse(e.Text, out int result);
        }
